...
const SCENE_DURATIONS = [4500, 5e3, 6e3, 4500, 5e3];
const TOTAL_SCENES = 5;
function useSceneTimer(scene, running, onAdvance) {
  reactExports.useEffect(() => {
    if (!running) return;
    const duration = SCENE_DURATIONS[scene] ?? 3e3;
    const id = setTimeout(onAdvance, duration);
    return () => clearTimeout(id);
  }, [scene, running, onAdvance]);
}
function Scene0Canvas({ opacity }) {
    ...
    const initParticles = () => {
      ...
      for (let i = 0; i < COLS * ROWS; i++) {
        ...
        particles.push({
          ...
          color: Math.random() > 0.85 ? "rgba(6,182,212," : Math.random() > 0.7 ? "rgba(255,200,80," : "rgba(255,255,255,",
  ...
  reactExports.useEffect(() => {
    ...
    const initNodes = () => {
      ...
      for (let i = 0; i < COUNT; i++) {
        nodes.push({
          ...
          r: Math.random() * 3 + 1.5,
          phase: Math.random() * Math.PI * 2,
          type: Math.random() > 0.7 ? "cpu" : Math.random() > 0.5 ? "signal" : "data"
        });
      }
    };
    initNodes();
    ...
    const draw = () => {
      ...
      for (const n of nodes) {
        ...
        const color = n.type === "cpu" ? "rgba(6,182,212," : n.type === "signal" ? "rgba(245,158,11," : "rgba(255,255,255,";
  ...
  reactExports.useEffect(() => {
    ...
    const initCloud = () => {
      ...
      for (let i = 0; i < CLOUD_COUNT; i++) {
        ...
        cloud.push({
          ...
          color: Math.random() > 0.6 ? "rgba(245,158,11," : Math.random() > 0.5 ? "rgba(255,200,80," : "rgba(255,255,255,",
    ...
    const draw = () => {
      ...
      for (let i = 0; i < 3; i++) {
        ...
        const dotX = cx + Math.cos(dotAngle) * ringRadius * (Math.abs(tiltFactor) * 0.6 + 0.4);
        ...
        for (let tr = 1; tr <= 5; tr++) {
          ...
          const trX = cx + Math.cos(trAngle) * ringRadius * (Math.abs(tiltFactor) * 0.6 + 0.4);
...
function CinematicIntro({ onComplete }) {
  const [scene, setScene] = reactExports.useState(0);
  const [sceneOpacity, setSceneOpacity] = reactExports.useState(0);
  const [fadeOut, setFadeOut] = reactExports.useState(false);
  const [capabilityIdx, setCapabilityIdx] = reactExports.useState(-1);
  ...
  const advanceScene = reactExports.useCallback(() => {
    setFadeOut(true);
    setTimeout(() => {
      setFadeOut(false);
      setSceneOpacity(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: baseStyle, children: [
        ...
        children: [0, 1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              height: 4,
              borderRadius: 2,
              background: i < scene ? "rgba(245,158,11,0.6)" : i === scene ? "rgba(245,158,11,1)" : "rgba(255,255,255,0.12)",
    ...
    scene === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: sceneWrap, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Scene0Canvas, { opacity: sceneOpacity }),
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                ...
                style: {
                  ...
                  height: "auto",
                  animation: "logo-slam-in 1.2s cubic-bezier(0.22,1,0.36,1) forwards",
                  filter: "drop-shadow(0 0 60px rgba(6,182,212,0.35)) drop-shadow(0 0 120px rgba(255,255,255,0.1))"
                }
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  width: "min(720px, 88vw)",
                  height: 1,
                  background: "linear-gradient(90deg, transparent, rgba(6,182,212,0.5), rgba(255,255,255,0.3), rgba(6,182,212,0.5), transparent)",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Sovereign Intelligence. Internet Computer."
              }
            )
          ]
        }
    ...
    scene === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...sceneWrap, flexDirection: "column" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Scene1Canvas, { opacity: sceneOpacity }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "The world built software."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
    ...
    scene === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...sceneWrap, flexDirection: "column" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Scene2Canvas, { opacity: sceneOpacity }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h1",
              {
                style: {
                  ...
                  fontWeight: 700,
                  letterSpacing: "0.5em",
                  textShadow: "0 0 40px rgba(245,158,11,0.9), 0 0 80px rgba(245,158,11,0.5), 0 0 160px rgba(245,158,11,0.2)",
                  margin: 0,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 30, display: "flex", alignItems: "center" }, children: capabilityIdx >= 0 && capabilityIdx < capabilities.length && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                style: {
    ...
    scene === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...sceneWrap, alignItems: "stretch" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Scene3Canvas, { opacity: sceneOpacity }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  position: "absolute",
                  inset: 0,
                  background: "linear-gradient(to right, transparent 55%, rgba(0,0,0,0.95) 100%), linear-gradient(to top, rgba(0,0,0,0.6) 0%, transparent 30%)"
                }
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Founder. Vision Architect."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Bringing the future now"
              }
            )
          ]
        }
    ...
    scene === 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...sceneWrap, flexDirection: "column", gap: 0 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Scene4Canvas, { opacity: sceneOpacity }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "We didn't bite the apple."
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "We waited for the orange."
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
